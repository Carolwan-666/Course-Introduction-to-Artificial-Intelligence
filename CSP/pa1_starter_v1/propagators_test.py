...
#c1 is constraint x == y + z.
#below are all of the satisfying tuples
c1.add_satisfying_tuples([[2, 1, 1], [3, 1, 2], [3, 2, 1]])

c2 = Constraint('C2', [w, x, y, z])
#c2 is constraint w == x + y + z.
#instead of writing down the satisfying tuples we compute them
...
print("Back-tracking w/o constraint propagation on a simple CSP")
btracker.bt_search(prop_BT)
print("\n")

print("Back-tracking w/ Forward-Checking on a simple CSP")
btracker.bt_search(prop_FC)
print("\n")

print("Back-tracking w/ Generalized Arc-Consistency on a simple CSP")
...
# trace = True
trace = False
print("Back-Tracking w/o Constraint Propagation on 8-queens")
solve_nQueens(8, 'BT', trace)
print("=======================================================")
print("Back-tracking w/ Forward-Checking on 8-queens")
solve_nQueens(8, 'FC', trace)
print("=======================================================")
print("bACK-tRACKING w/ Generalized Arc-Consistency on 8-queens")
